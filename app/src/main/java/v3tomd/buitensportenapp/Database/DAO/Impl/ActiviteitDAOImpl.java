...
class ActiviteitDAOImpl implements ActiviteitDAO{
    ...
    public ActiviteitDAOImpl(){
        ...
        Activiteit activiteit1 = new Activiteit("Trap die bal!", Activiteit.eSportType.Voetbal, StartDate,EndDate, 1, 99,0 ,8 , locatie1);
        Activiteit activiteit2 = new Activiteit("Win die Jordans", Activiteit.eSportType.Basketbal, StartDate,EndDate, 1, 99, 0, 8  ,locatie2);
        Activiteit activiteit3 = new Activiteit("Hockey met een stockey!", Activiteit.eSportType.Hockey, StartDate,EndDate, 1, 99, 0,8, locatie3);
